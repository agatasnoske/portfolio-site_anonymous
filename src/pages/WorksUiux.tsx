...
import { WorksUiuxData } from './WorksUiuxData'

export default function WorksUiux() {
  const [selectedItem, setSelectedItem] = useState<null | typeof WorksUiuxData[0]>(null)

  return (
    <>
      <ul className="worksitems fade">
        {WorksUiuxData.map((item, index) => (
