...
import { WorksWebDesignData } from './WorksWebDesignData'

export default function WorksWebDesign() {
    const [selectedItem, setSelectedItem] = useState<null | typeof WorksWebDesignData[0]>(null)

    return (
    <>
        <ul className="worksitems fade">
        {WorksWebDesignData.map((item, index) => (
