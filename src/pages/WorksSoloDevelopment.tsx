...
import { WorksSoloDevelopmentData } from './WorksSoloDevelopmentData'

export default function WorksSoloDevelopment() {
  const [selectedItem, setSelectedItem] = useState<null | typeof WorksSoloDevelopmentData[0]>(null)
  ...
  return (
    <>
      <ul className="worksitems fade">
        {WorksSoloDevelopmentData.map((item, index) => (
