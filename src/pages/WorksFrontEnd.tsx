...
import { worksFrontEndData } from './WorksFrontEndData'

export default function WorksFrontEnd() {
  const [selectedItem, setSelectedItem] = useState<null | typeof worksFrontEndData[0]>(null)

  return (
    <>
      <ul className="worksitems fade">
        {worksFrontEndData.map((item, index) => (
